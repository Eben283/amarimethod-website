...
**Default ladder (everyone except Founder's Circle):**
| Service | Price | Notes |
|---------|-------|-------|
...
| Upgrade Initial→4 / Initial→8 / 4→8 | $495 / $1,070 / $575 |
| Entrainment | $90 |

Also: Initial $225 · Assessment $29 · Living Practice standalone $347 · Discovery free.

Dual-price single helper: `functions/lib/session-pricing.js`.
