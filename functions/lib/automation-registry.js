...
const NURTURE_CUTOVER_READINESS = Object.freeze({
  "flow-1-quiz": Object.freeze({
    ...
    requirements: Object.freeze([
      ...
      Object.freeze({ code: "public_quiz_bridge_release_pending", status: "blocked", label: "Review and release the owned quiz bridge", detail: "Source mode is hardcoded shadow and an independent release flag plus private CRM service binding are absent. GHL remains the live intake owner until the bridge source, binding, schema and shadow readback are separately approved." }),
