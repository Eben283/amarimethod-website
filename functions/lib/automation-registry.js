...
const NO_SHOW_RECOVERY_CUTOVER_READINESS = Object.freeze({
  ...
  requirements: Object.freeze([
    ...
    Object.freeze({ code: "owned_recovery_runtime_pending", status: "blocked", label: "Install and release the recovery runtime", detail: "Migrations 0025–0026 and the reviewed CRM, Reminder, and Pages source are not installed or deployed. Production remains unchanged until separately guarded releases and readback." }),
