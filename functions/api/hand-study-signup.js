// Cloudflare Pages Function: POST /api/hand-study-signup
...
export async function onRequestPost(context) {
  ...
  return legacyStudySignupDisabledResponse(headers, "hand");
  ...
  try {
    ...
    if (kv) {
      ...
      const rateKey = `hand_study_signup_rate:${clientIP}`;
