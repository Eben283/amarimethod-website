// Cloudflare Pages Function: POST /api/foot-study-signup
...
const STUDY = STUDIES["runners-lower-leg"];
...
export async function onRequestPost(context) {
  ...
  return legacyStudySignupDisabledResponse(headers, "runners-lower-leg");
  ...
  try {
    ...
    if (kv) {
      ...
      const rateKey = `foot_study_signup_rate:${clientIP}`;
