// Cloudflare Pages Function: POST /api/shoulder-study-signup
...
const STUDY = STUDIES["desk-shoulders"];
...
export async function onRequestPost(context) {
  ...
  return legacyStudySignupDisabledResponse(headers, "desk-shoulders");
  ...
  try {
    ...
    if (kv) {
      ...
      const rateKey = `shoulder_study_signup_rate:${clientIP}`;
