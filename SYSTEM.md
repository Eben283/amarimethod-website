...
|------|------|-------|-------|
| Slot policy (duration/interval/buffer) | Native catalog | `functions/lib/booking-slot-policy.js` | Follow-up 50 min on-the-hour is priority; studio `interval=60`. GHL still serves free-slots; policy is the Amari seed + drift check. Doc: `decision_booking_slot_model.md` |
