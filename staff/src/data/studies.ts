...
export const STUDIES: Record<string, StudyConfig> = {
  ...
  'shoulder-study-participant': { key: 'desk-shoulders', tag: 'shoulder-study-participant', module: 'power-posture', condition: 'shoulder & upper-back pain', shortName: 'Desk Shoulders Study', bodyQuestion: SHOULDER, impactLabel: 'How it affects reaching or desk work', instrumentAbbr: 'SPADI', status: 'live' },
