...
function PublicRoute({ children }: { children: React.ReactNode }) {
  ...
  if (isAuthenticated) {
    const requested = typeof location.state?.returnTo === 'string' ? location.state.returnTo : '/';
    const returnTo = requested.startsWith('/') && !requested.startsWith('//') && !requested.startsWith('/login') ? requested : '/';
  ...
  return <>
    <Routes>
      <Route element={<ProtectedStaffLayout />}>
        ...
        <Route path="client/:id" element={<Layout fullBleed><ClientDetailPage surface="session" /></Layout>} />
        <Route path="client/:id/session" element={<Layout fullBleed><ClientDetailPage surface="session" /></Layout>} />
        <Route path="client/:id/record" element={<Layout fullBleed><ClientDetailPage surface="record" /></Layout>} />
        ...
        <Route path="partner-rewards" element={<Layout><PartnerRewardsPage /></Layout>} />
        ...
        <Route path="project-novak" element={<Layout><ProjectNovakPage /></Layout>} />
