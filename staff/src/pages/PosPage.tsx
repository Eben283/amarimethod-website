...
const CATALOG = [
  ...
  ["follow-up", "Single Session", 28500, "Single sessions", "Single session · $285"],
  ["follow-up-founders", "Single follow-up (Founder's Circle)", 19000, "Single sessions", "Legacy $190"],
