...
type ParticipantForm = { fieldStudyKey: FieldStudyKey | ''; firstName: string; lastName: string; phone: string; email: string; paperDate: string; canUseFirstName: boolean; afterSessionOnePain: number | null; participantQuote: string };
...
function blankParticipant(): ParticipantForm { return { fieldStudyKey: '', firstName: '', lastName: '', phone: '', email: '', paperDate: localDate(), canUseFirstName: false, afterSessionOnePain: null, participantQuote: '' }; }
