...
export const COURSE_MODULES: readonly Module[] = [
  ...
  },
  {
    ...
    lessons: [
      ...
      { slug: 'passive-bridge-demo', title: 'Passive Bridge — Exercise Demo', videoUrl: `${CDN}/69c30764cf4f9a6d64158fd6.mp4`, durationSeconds: 0 },
      { slug: 'passive-bridge-discussion', title: 'Passive Bridge Discussion', videoUrl: `${CDN}/69c30764f9ac78710958809c.mp4`, durationSeconds: 0 },
      { slug: 'active-bridge-discussion', title: 'Active Bridge Discussion', videoUrl: `${CDN}/69c30764eaed06570fa85743.mp4`, durationSeconds: 0 },
      { slug: 'passive-bridge-tips', title: 'Passive Bridge — Tips and Common Mistakes', videoUrl: `${CDN}/69c30764fe4d0d3fcbd568ae.mp4`, durationSeconds: 0 },
      { slug: 'active-bridge-demo', title: 'Active Bridge — Exercise Demo', videoUrl: `${CDN}/69c30764510803387ad90d1a.mp4`, durationSeconds: 0 },
      { slug: 'active-bridge-tips', title: 'Active Bridge — Tips and Common Mistakes', videoUrl: `${CDN}/69c33128eaed06392cad7fc5.mp4`, durationSeconds: 0 },
